...
from encoder_module.attention_module import RelPosMultiHeadSelfAttention, DeformableMultiHeadedAttention, ContextualMultiHeadAttention, MultiHeadAttention
